...
const morfImage = new UIImage(morf, new Texture(resources.IMAGE_MORF))
...
const ruImage = new UIImage(ru, new Texture(resources.IMAGE_RU))
...
const RUdesc = new UIImage(canvas1, new Texture(resources.IMAGE_RU_DESC));
RUdesc.width = "0px"
